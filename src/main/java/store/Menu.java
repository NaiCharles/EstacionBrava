...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        MiTiendita.setForeground(new java.awt.Color(204, 204, 204));
        MiTiendita.setText("Productos");
        getContentPane().add(MiTiendita, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 20, -1, -1));

        ivProducto1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/imagenes/Hamburguesa.png"))); // NOI18N
        getContentPane().add(ivProducto1, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 92, 170, 170));

        ivProducto2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/imagenes/Tacos.png"))); // NOI18N
        getContentPane().add(ivProducto2, new org.netbeans.lib.awtextra.AbsoluteConstraints(225, 92, 170, 170));

        ivProducto3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/store/imagenes/tacos de pastor.png"))); // NOI18N
        ...
        tAceiteVegetal.setText("Hamburguesa");
        ...
        tLeche.setText("Tacos de trompo");
        ...
        tAtun.setText("Tacos de pastor");
        getContentPane().add(tAtun, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, -1, -1));
        ...
        precio1.setForeground(new java.awt.Color(255, 0, 0));
        precio1.setText("$60");
        getContentPane().add(precio1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, -1, -1));

        precio2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        precio2.setForeground(new java.awt.Color(255, 0, 0));
        precio2.setText("$80");
        getContentPane().add(precio2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 290, -1, -1));

        precio3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        precio3.setForeground(new java.awt.Color(255, 0, 0));
        precio3.setText("$80");
        getContentPane().add(precio3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 290, -1, -1));
    ...
    private void btResta1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    ...
    private void btResta2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    ...
    private void btResta3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    ...
    private void btResta4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    ...
    private void btSuma2ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        Integer cantidad = Integer.parseInt(etCantidad2.getText());
    ...
    private void btPagarActionPerformed(java.awt.event.ActionEvent evt) {                                        
    ...
    private void btSuma1ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        Integer cantidad = Integer.parseInt(etCantidad1.getText());
    ...
    private void btSuma3ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        Integer cantidad = Integer.parseInt(etCantidad3.getText());
    ...
    private void btSuma4ActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
        Integer cantidad = Integer.parseInt(etCantidad4.getText());
    ...
    private void etCantidad1ActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
    }                                           
    ...
    private void btCleanVentaActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
        etCantidad1.setText("0");
        etCantidad2.setText("0");
        etCantidad3.setText("0");
