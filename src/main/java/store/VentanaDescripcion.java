...
public class VentanaDescripcion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtArticulo1.setText("Hamburguesa");
        ...
        txtArticulo2.setText("Tacos de trompo");
        getContentPane().add(txtArticulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 140, -1));

        txtArticulo3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo3.setText("Tacos de pastor");
    ...
    private void btRegresarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    ...
    public void cantidades(String cantidad1, String cantidad2, String cantidad3, String cantidad4){
        ...
        //precios
        txtPrecioSinIVA1.setText("$60");
        txtPrecioSinIVA2.setText("$80");
        txtPrecioSinIVA3.setText("$80");
        txtPrecioSinIVA4.setText("$25");
        //precios + iva
        float p1 = 60 + (60f*0.16f);
        float p2 = 80f + (80f*0.16f);
        float p3 = 80f + (80f*0.16f);
        float p4 = 25f + (25f*0.16f);
